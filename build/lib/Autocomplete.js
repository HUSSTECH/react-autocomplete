  ...
  _createClass(Autocomplete, [{
    ...
    value: function maybeAutoCompleteText(state, props) {
      ...
      if (value !== '' && matchedItem) {
        ...
        var itemValueDoesMatch = this.props.valueItemComparison(itemValue, value);
...
Autocomplete.defaultProps = {
  ...
  valueItemComparison: function valueItemComparison(optionItemValue, inputValue) {
    return optionItemValue.toLowerCase().indexOf(inputValue.toLowerCase()) === 0;
  }
};
